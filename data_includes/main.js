...
// Interference phase 
PennController.Template("InterferenceCond4b.csv", row=>
newTrial("InterferenceCond4b",
    //noTopMargin(),
    ...
    ,
    newCanvas( 'Interference4b', "90vw", "80vh")
    .add( "25vw", "0vh", getImage("bubble"), 0 )
    .add( "35vw", "32vh", getImage("Alien"), 1 )
    .add( "28vw", "7vh", getText("word"), 2 )
    .add( "45vw", "1vh", getImage("item"), 3 )
...
//Testing phase
//Suffix selection Q2
PennController.Template("Test_Flipped_Q2.csv", row=>
...
PennController.Template("Test_Flipped_Q1.csv", row=>
